...
const alerts = [
  {
    ...
    location: "Cordón",
    description: "Coffee beans -15% vs theoretical stock",
    severity: "high",
    action: "Review inventory logs",
  },
  {
    id: 2,
    icon: Users,
    title: "Overstaffing Alert",
    location: "Punta Carretas",
    description: "14:00 - 16:00: 3 extra staff vs demand",
    severity: "medium",
  ...
  },
  {
    ...
    location: "Pocitos",
    description: "Food margin down 4.2% this week",
    severity: "medium",
  ...
  return (
    <div className="overflow-hidden rounded-xl border-2 border-destructive/40 bg-card/80 backdrop-blur-sm">
      <div className="flex items-center gap-2 border-b border-destructive/20 bg-destructive/5 px-5 py-3">
        ...
        <h3 className="text-base font-semibold text-foreground">Money Leak Alerts</h3>
